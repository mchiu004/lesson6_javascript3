...
function populateFigures() {
    ...
    for(var i = 1; i < 4; i++){
        ...
        currentFig.src = filename;
            ...
            for(var i = 0; i <5; i++){
                filename = "images/IMG_0" + photoOrder[i] + "sm.jpg";
                currentFig = document.getElementByTagName("img")[i];
                currentFig.src = filename;
            }//end of for loop
        }// end of else
...
function createEventListeners() {
    ...
    //the leftarrow() function will be executed when the user clicks the left nav arrow button
    ...
    //the rightArrow function will be executed when user clicks the right nav button
